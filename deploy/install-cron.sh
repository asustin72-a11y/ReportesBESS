...
echo ""
echo "Auto-reparacion NTP (opcional, una vez como root):"
echo "  sudo cp $ROOT/deploy/sudoers-bess-ntp.example /etc/sudoers.d/bess-ntp"
echo "  sudo chmod 440 /etc/sudoers.d/bess-ntp"
echo "  sudo visudo -cf /etc/sudoers.d/bess-ntp"
